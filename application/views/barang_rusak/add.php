        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="id_barang_rusak">ID Transaksi Barang Rusak</label>
                    <div class="col-md-4">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <input value="<?= set_value('tanggal_rusak', date('Y-m-d')); ?>" name="tanggal_rusak" id="tanggal_rusak" type="text" class="form-control date" placeholder="Tanggal Masuk...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <input value="<?= set_value('jumlah_rusak'); ?>" name="jumlah_rusak" id="jumlah_rusak" type="number" class="form-control" placeholder="Jumlah Rusak..." min="1">
                            <div class="input-group-append">
