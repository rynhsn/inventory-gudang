...
<head>
    ...
    <link rel="icon" type="image/png" href="assets/hrs.jpg"/>
    <title><?= $title; ?> | Aplikasi inventory Gudang </title>
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="<?= base_url('dashboard'); ?>">
                ...
                <div class="sidebar-brand-icon">
                  ...
                  <i aria-hidden="true"><img src="<?= base_url(); ?>assets/img/hrs.jpg" width="50"></i>
                </div>
                <div class="sidebar-brand-text mx-3">Housekeeping</div>
            </a>
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('barang'); ?>">Data Barang di Gudang</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseStatus" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('baranghilang'); ?>">Barang Hilang</a>
                    </div>
                </div>
            </li>
...
``
                    ...
                    <ul class="navbar-nav ml-auto">
						<li class="nav-item no-arrow">
							<a class="nav-link" href="https://time.is/Serang" id="time_is_link" rel="nofollow">
                                <span class="mr-2 d-none d-lg-inline small text-capitalize">
                                    Serang,
                                </span>
								<span id="Serang_z41c" style="font-size:15px"></span>
								<script src="//widget.time.is/t.js"></script>
								<script>time_is_widget.init({Serang_z41c:{}});</script>
							</a>
						</li>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Aplikasi HK-Inventory &bull; 2023 &bull; by <?= anchor('SKRIPSI'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script type="text/javascript">
        ...
        if(hal == 'barangmasuk'){
            jumlah = $('#jumlah_masuk');
        }else if(hal == 'barangkeluar'){
            jumlah = $('#jumlah_keluar');
        }else if(hal == 'barangrusak'){
            jumlah = $('#jumlah_rusak');
        }else if(hal == 'baranghilang'){
        ...
        $(document).on('keyup', '#jumlah_hilang', function() {
            let totalStok = parseInt(stok.val()) - parseInt(this.value);
            total.val(Number(totalStok));
        });
        ...
        $(document).on('change', '#jumlah_rusak', function() {
            let totalStok = parseInt(stok.val()) - parseInt(this.value);
            total.val(Number(totalStok));
        });

        $(document).on('change', '#jumlah_hilang', function() {
            let totalStok = parseInt(stok.val()) - parseInt(this.value);
            total.val(Number(totalStok));
        });
    </script>
    ...
    <?php if ($this->uri->segment(1) == 'dashboard') : ?>
        ...
        <script type="text/javascript">
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        },
                        {
                            ...
                            lineTension: 0.3,
                            backgroundColor: "rgba(231, 74, 59, 0.05)", 
                            borderColor: "#E7863BFF",
                            pointRadius: 3,
                            pointBackgroundColor: "#E7863BFF",
                            pointBorderColor: "#E7863BFF",
                            pointHoverRadius: 3,
                            pointHoverBackgroundColor: "#5a5c69",
                            pointHoverBorderColor: "#5a5c69",
                            pointHitRadius: 10,
                            pointBorderWidth: 2,
                            data: <?= json_encode($cbr); ?>,
                        },
                        {
                            ...
                            borderColor: "#494949",
                            pointRadius: 3,
                            pointBackgroundColor: "#494949",
                            pointBorderColor: "#494949",
                            pointHoverRadius: 3,
                            pointHoverBackgroundColor: "#5a5c69",
                            pointHoverBorderColor: "#5a5c69",
                            pointHitRadius: 10,
                            pointBorderWidth: 2,
                            data: <?= json_encode($cbh); ?>,
                        }
                    ],
                },
                options: {
            ...
            var myPieChart = new Chart(ctx, {
                type: 'doughnut',
                data: {
                    labels: ["Barang Masuk", "Barang Keluar", "Barang Rusak", "Barang Hilang"],
                    datasets: [{
                        data: [<?= $barang_masuk; ?>, <?= $barang_keluar; ?>, <?= $barang_rusak; ?>, <?= $barang_hilang; ?>],
                        backgroundColor: ['#4e73df', '#e74a3b', '#ffb600', '#494949'],
                        hoverBackgroundColor: ['#5a5c69', '#5a5c69', '#5a5c69', '#5a5c69'],
