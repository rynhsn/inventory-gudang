            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="custom-control custom-radio">
                            <input <?= $user['role'] == 'spv' ? 'checked' : ''; ?> <?= set_radio('role', 'spv'); ?> value="spv" type="radio" id="spv" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="spv">SPV</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input <?= $user['role'] == 'ehk' ? 'checked' : ''; ?> <?= set_radio('role', 'ehk'); ?> value="ehk" type="radio" id="ehk" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="ehk">EHK</label>
                        </div>
